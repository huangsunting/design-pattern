...
import com.bravo.pattern.chain_of_responsibility.verifier.refactor3.support.ChannelEnum;
import com.bravo.pattern.chain_of_responsibility.verifier.refactor3.verifier.OrderConvertVerifier;
import com.bravo.pattern.chain_of_responsibility.verifier.refactor3.verifier.common.ChannelRelationBindingVerifier;
import com.bravo.pattern.chain_of_responsibility.verifier.refactor3.verifier.common.OrderNoConvertedVerifier;
import com.bravo.pattern.chain_of_responsibility.verifier.refactor3.verifier.douyin.DouYinFirstConvertVerifier;
