package com.bravo.pattern.chain.filter.node_impl;
...
import com.bravo.pattern.chain.filter.node_impl.filter.AFilter;
import com.bravo.pattern.chain.filter.node_impl.filter.BFilter;
import com.bravo.pattern.chain.filter.node_impl.filter.CFilter;
import com.bravo.pattern.chain.filter.node_impl.filter.DFilter;
